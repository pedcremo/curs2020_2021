...
/**
 * Function where we have the actions of the players modal, which returns the template of the modal
 */
...
export const modalPlayers = () => {
    const controllers = () => {
        ...
        if (addButton) {
            ...
            addButton.addEventListener("click", (event) => {
                ...
                if (namePlayer) {
                    ...
                    li.addEventListener('click', (event) => {
                        li.remove();
                        /** lastchild to can remove the last player that you just added */
        ...
        /** YOU CAN MUTED THE BACKGORUND VIDEO SOUN */
